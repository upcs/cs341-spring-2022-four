...
### 2.1/2 Product Overview and Product Features
The key features of the website are the ability to search for Portland hikes based on name, length, elevation change, difficulty, and rating. The website will allow users to view hikes and obtain information about them such as length and elevation change as well as view reviews of the hikes. Furthermore, we will allow users to create profiles and track the hikes they have completed and in doing so earn achievements. Furthermore, users will be able to rate hikes so that others may view their feedback. The features are depicted below in the following diagram:
![TODO]()
...
Description:  
  ...
  User clicks on the “Add hike” button 
    A pop-up appears that says that the hike has been added 
    User clicks the “ok” button to close the pop-up 
...
Alternates: 
    ...
    User Removing a Hike from their List of Completed Hikes 
...
Description:  
    ...
    Bob scrolls through her completed hikes to the hike he didn’t complete  

    He clicks on the hike to open up the hike information  

    Bob scrolls down to the bottom of the hike page  

    Bob selects the option to remove hike 

    A popup window comes up to verify Bob really wants to remove the hike from list of completed hikes 

    Bob confirms 

    The hike is removed from Bob’s list of completed hikes 
...
Alternates: 
    ...
    User Adding a New Hike to the Database 

Primary Actor: User is a hiker who hiked a trail that isn’t in the database 

Pre-condition: User is logged in 

Description: 

    User clicks on profile image in the top right-hand corner of site to navigate to their profile 

    User scrolls down to “Fully Sent” section of their profile which contains a list of their completed hikes 

    User clicks on button “Add Other Hike” which is next to “Fully Sent” header at the top of the list.  

    A card opens with empty fields for hike information 

    User clicks on “Hike Name” field and types “Super Waterfall Hike” 

    User clicks on “Distance” and enters “837” miles 

    User clicks on “Elevation Change” and enters “18,000” feet 

    User clicks on plus button under “Pictures” heading. Their photos open up. They scroll through and click on a picture of a waterfall. Their photos close and the photo is automatically uploaded to the card  

    User clicks on “Add” button. The card closes and the hike appears in their “Fully Sent” section 

Post-condition: the information the user inputted is put in a queue to receive official confirmation 

Alternates: 

    User leaves a field blank and clicks “Add” button. If the name is left blank give a user error and highlight the name field. If any other field is blank, add the hike normally but with nothing in the blank fields 

    User enters a non-number in “Distance” or “Elevation Change” fields. Present a user error and highlight the field 
